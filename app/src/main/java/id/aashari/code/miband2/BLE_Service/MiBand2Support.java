...
//
//import id.aashari.code.miband2.BLE_Service.Action.BtLEAction;
...
//
//        addSupportedService(BluetoothService.UUID_SERVICE_MIBAND_SERVICE);
//        addSupportedService(BluetoothService.UUID_SERVICE_MIBAND2_SERVICE);
//        addSupportedService(BluetoothService.UUID_SERVICE_FIRMWARE_SERVICE);
//
...
////todo  Here is device event like WOKE_UP and FALL_ASLEEP
