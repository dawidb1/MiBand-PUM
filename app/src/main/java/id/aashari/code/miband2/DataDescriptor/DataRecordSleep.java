...
package id.aashari.code.miband2.DataDescriptor;
...
import id.aashari.code.miband2.DataDescriptor.DataRecord;
import id.aashari.code.miband2.Helpers.ActivityKind;

public class DataRecordSleep extends DataRecord {
    ...
    public DataRecordSleep(byte[] data) {
